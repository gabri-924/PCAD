...
class ClientNoDL extends Thread{
    private int id;
    private Semaphore spogliatoi;
    private Semaphore armadietti;

    public ClientNoDL(int id, Semaphore spogliatoi, Semaphore armadietti){
        this.id = id;
    ...
    public void run(){
        try{
            System.out.println("Client " + id + " attende armadietto...");
            armadietti.acquire();
            System.out.println("Client " + id + " ha preso armadietto. Attende spogliatoio");
            spogliatoi.acquire();
